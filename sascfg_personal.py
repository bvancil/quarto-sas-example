...
#
# SAS_config_names = ["default", "ssh", "iom", "local", "httpsviya", "httpviya", "iomcom"]
#

SAS_config_names = ["local"]
...
SAS_output_options = {
    "output": "html5"
}  # not required unless changing any of the default
...
httpsviya = {
    "ip": "sastpw.rndk8s.openstack.sas.com",
